...
- イベントA（Event-A）: 価格は概念値、在庫は初期在庫例
  ...
  5. EVT-A-005 | ポスター A2 | ¥1,200 | stock 80
...
-- イベントB（Event-B）
  1. EVT-B-001 | Tシャツ（白） | ¥3,300 | stock 45
  2. EVT-B-002 | Tシャツ（黒） | ¥3,300 | stock 45
  3. EVT-B-003 | フェイスタオル | ¥1,400 | stock 90
  4. EVT-B-004 | トレカ（ブースター） | ¥2,100 | stock 180
  5. EVT-B-005 | ポスター（限定版） | ¥1,300 | stock 70
  6. EVT-B-006 | 缶バッジ（セット） | ¥600 | stock 250
  7. EVT-B-007 | アクリルキーホルダー | ¥1,600 | stock 80
  8. EVT-B-008 | ステッカー（シート） | ¥750 | stock 140
  9. EVT-B-009 | フォトセット | ¥2,200 | stock 55
  10. EVT-B-010 | キャップ（イベント） | ¥2,400 | stock 35

-- イベントC（Event-C）
  1. EVT-C-001 | Tシャツ（限定色） | ¥3,800 | stock 40
  2. EVT-C-002 | Tシャツ（黒） | ¥3,800 | stock 40
  3. EVT-C-003 | マフラータオル | ¥2,000 | stock 50
  4. EVT-C-004 | トレカセット（10枚） | ¥2,000 | stock 160
  5. EVT-C-005 | ポスター A2（サイン入り） | ¥1,800 | stock 30
  6. EVT-C-006 | 缶バッジ（ランダム） | ¥500 | stock 280
  7. EVT-C-007 | アクリルスタンド（ミニ） | ¥1,700 | stock 65
  8. EVT-C-008 | クリアファイル | ¥900 | stock 120
  9. EVT-C-009 | ブロマイドセット | ¥2,200 | stock 85
  10. EVT-C-010 | ミニライト | ¥2,300 | stock 60
